 ...
 * 
 */
package smartgrid.simcontrol.baselib.attackersimulation;
...
public enum HackingStyle {
	...
	/**
	 * With this Style the Attacker will hack every Node in the his Cluster without respecting logical Connections
	 */
