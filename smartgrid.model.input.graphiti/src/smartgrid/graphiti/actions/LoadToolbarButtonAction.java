...
public class LoadToolbarButtonAction extends ToolbarButtonAction {
     ...
     */
    private Object resolveBOfromNetworkEntity(final NetworkEntity toResolve, final EList<?> loadedBO) {
     ...
     * @return the resolve bo
     */
    private Object resolveBOfromPowergridNode(final PowerGridNode toResolve, final EList<?> loadedBO) {
        for (final Object obj : loadedBO) {
            if (obj instanceof EntityState && ((EntityState) obj).getOwner().getId() == toResolve.getId()) {
                return obj;
            }
