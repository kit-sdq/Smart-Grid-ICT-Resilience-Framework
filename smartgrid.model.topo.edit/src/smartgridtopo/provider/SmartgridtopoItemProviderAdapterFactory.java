...
public class SmartgridtopoItemProviderAdapterFactory extends SmartgridtopoAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
	...
	public void dispose() {
		...
		if (powerGridNodeItemProvider != null) powerGridNodeItemProvider.dispose();
		if (smartMeterItemProvider != null) smartMeterItemProvider.dispose();
		if (smartMeterTypeItemProvider != null) smartMeterTypeItemProvider.dispose();
		...
		if (networkNodeTypeItemProvider != null) networkNodeTypeItemProvider.dispose();
		...
		if (logicalCommunicationItemProvider != null) logicalCommunicationItemProvider.dispose();
	}
