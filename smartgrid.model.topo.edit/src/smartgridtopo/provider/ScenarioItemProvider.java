...
/**
 * This is the item provider adapter for a {@link smartgridtopo.Scenario} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScenarioItemProvider
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SmartgridtopoPackage.Literals.SCENARIO__CONTAINS_NE);
            childrenFeatures.add(SmartgridtopoPackage.Literals.SCENARIO__CONTAINS_PGN);
            childrenFeatures.add(SmartgridtopoPackage.Literals.SCENARIO__CONTAINS_C);
            childrenFeatures.add(SmartgridtopoPackage.Literals.SCENARIO__CONTAINS_LC);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (SmartgridtopoPackage.Literals.SCENARIO__CONTAINS_NE,
        ...
        newChildDescriptors.add
            (createChildParameter
                (SmartgridtopoPackage.Literals.SCENARIO__CONTAINS_PGN,
                 SmartgridtopoFactory.eINSTANCE.createPowerGridNode()));

        newChildDescriptors.add
            (createChildParameter
                (SmartgridtopoPackage.Literals.SCENARIO__CONTAINS_C,
                 SmartgridtopoFactory.eINSTANCE.createPhysicalConnection()));

        newChildDescriptors.add
            (createChildParameter
                (SmartgridtopoPackage.Literals.SCENARIO__CONTAINS_LC,
