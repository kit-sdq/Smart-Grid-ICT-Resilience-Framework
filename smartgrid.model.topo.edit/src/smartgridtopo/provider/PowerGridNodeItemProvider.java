...
/**
 * This is the item provider adapter for a {@link smartgridtopo.PowerGridNode} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PowerGridNodeItemProvider extends ItemProviderAdapter
     ...
     * @generated
     */
    public PowerGridNodeItemProvider(AdapterFactory adapterFactory) {
    ...
    /**
     * This returns PowerGridNode.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/PowerGridNode"));
    }
    ...
    public String getText(Object object) {
        String label = ((PowerGridNode) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_PowerGridNode_type") : getString("_UI_PowerGridNode_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(PowerGridNode.class)) {
