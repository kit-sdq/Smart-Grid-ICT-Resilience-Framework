 ...
 * @generated
 */
public class PhysicalConnectionItemProvider 
	...
	protected void addLinksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PhysicalConnection_Links_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PhysicalConnection_Links_feature", "_UI_PhysicalConnection_type"),
				 SmartgridtopoPackage.Literals.PHYSICAL_CONNECTION__LINKS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIsAPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PhysicalConnection_IsA_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PhysicalConnection_IsA_feature", "_UI_PhysicalConnection_type"),
				 SmartgridtopoPackage.Literals.PHYSICAL_CONNECTION__IS_A,
				 true,
				 false,
				 true,
				 null,
