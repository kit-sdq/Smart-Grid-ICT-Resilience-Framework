 ...
 * @generated
 */
public class NetworkEntityItemProvider 
	...
	protected void addConnectedToPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NetworkEntity_ConnectedTo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NetworkEntity_ConnectedTo_feature", "_UI_NetworkEntity_type"),
				 SmartgridtopoPackage.Literals.NETWORK_ENTITY__CONNECTED_TO,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLinkedByPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NetworkEntity_LinkedBy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NetworkEntity_LinkedBy_feature", "_UI_NetworkEntity_type"),
				 SmartgridtopoPackage.Literals.NETWORK_ENTITY__LINKED_BY,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_NetworkEntity_type") :
			getString("_UI_NetworkEntity_type") + " " + label;
	}
