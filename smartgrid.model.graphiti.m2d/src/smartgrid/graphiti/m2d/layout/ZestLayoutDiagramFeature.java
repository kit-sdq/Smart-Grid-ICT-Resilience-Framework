...
public class ZestLayoutDiagramFeature extends AbstractCustomFeature {
	 ...
	 * 
	 * @see
	 * org.eclipse.graphiti.features.custom.AbstractCustomFeature#canExecute(org
	 ...
	 *
	 * @return a {@link Map} of initial {@link Anchor} location {@link Point}
	...
	/**
	 * Reposition the bendpoints based on the offset from the initial
	 * {@link Anchor} location to the new location
	 *
	 * @param selves
	 *            The {@link Map} of initial {@link Anchor} location
	 ...
	 * based on the Zest {@link LayoutAlgorithm} computed locations
	 *
	 * @param entities
	 * @param connections
	 */
	...
	/**
	 * @param map
	 *            a {@link Map} of {@link SimpleNode} per {@link Shape} - used
	 *            to link {@link SimpleRelationship} to source and target
	 *            entities
	 ...
	 * subclass used to hold the Graphiti connection reference
	 */
