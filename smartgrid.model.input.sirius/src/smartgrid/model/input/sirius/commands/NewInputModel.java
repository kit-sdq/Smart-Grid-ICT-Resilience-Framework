...
import smartgrid.model.input.sirius.InputModelCreator;
 ...
 *
 */
public class NewInputModel extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        final InputModelCreator creator = new InputModelCreator(rep);
        String inputID = creator.createNewInputModel(false);
