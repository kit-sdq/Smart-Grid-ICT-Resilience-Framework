...
public class SmartgridinputAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected SmartgridinputSwitch<Adapter> modelSwitch =
		new SmartgridinputSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link smartgridinput.ScenarioState <em>Scenario State</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link smartgridinput.EntityState <em>Entity State</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link smartgridinput.PowerState <em>Power State</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
