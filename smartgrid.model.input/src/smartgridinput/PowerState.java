...
public interface PowerState extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>Power Outage</b></em>' attribute. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Power Outage</em>' attribute isn't clear, there really should be
    ...
    /**
     * Sets the value of the '{@link smartgridinput.PowerState#isPowerOutage <em>Power Outage</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Power Outage</em>' attribute.
     * @see #isPowerOutage()
     * @generated
     */
