...
public interface SmartgridinputPackage extends EPackage {
    ...
    /**
     * The meta object id for the '{@link smartgridinput.impl.ScenarioStateImpl <em>Scenario
    ...
    /**
     * The number of structural features of the '<em>Scenario State</em>' class. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     * @generated
     * @ordered
    ...
    /**
     * The number of operations of the '<em>Scenario State</em>' class. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     * @ordered
    ...
    /**
     * The meta object id for the '{@link smartgridinput.impl.EntityStateImpl <em>Entity
     * State</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The feature id for the '<em><b>Is Destroyed</b></em>' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     * @ordered
    ...
    /**
     * The meta object id for the '{@link smartgridinput.impl.PowerStateImpl <em>Power State</em>}'
    ...
    /**
     * The feature id for the '<em><b>Power Outage</b></em>' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     * @ordered
    ...
    /**
     * The number of operations of the '<em>Power State</em>' class. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     * @ordered
    ...
    /**
     * Returns the meta object for class '{@link smartgridinput.ScenarioState <em>Scenario
    ...
    /**
     * Returns the meta object for the reference '{@link smartgridinput.ScenarioState#getScenario
    ...
    /**
     * Returns the meta object for the attribute '{@link smartgridinput.EntityState#isIsDestroyed
     * <em>Is Destroyed</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns the meta object for the attribute '{@link smartgridinput.EntityState#isIsHacked
     * <em>Is Hacked</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns the meta object for the reference '{@link smartgridinput.EntityState#getOwner
    ...
    /**
     * Returns the meta object for the reference '{@link smartgridinput.PowerState#getOwner
     * <em>Owner</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @return the meta object for the reference '<em>Owner</em>'.
    ...
    /**
     * Returns the meta object for the attribute '{@link smartgridinput.PowerState#isPowerOutage
     * <em>Power Outage</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    interface Literals {
        /**
         * The meta object literal for the '{@link smartgridinput.impl.ScenarioStateImpl
         * <em>Scenario State</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
         * 
         * @see smartgridinput.impl.ScenarioStateImpl
         * @see smartgridinput.impl.SmartgridinputPackageImpl#getScenarioState()
         * @generated
        ...
        /**
         * The meta object literal for the '<em><b>Entity States</b></em>' containment reference
        ...
        /**
         * The meta object literal for the '{@link smartgridinput.impl.EntityStateImpl <em>Entity
         * State</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
         * 
         * @see smartgridinput.impl.EntityStateImpl
         * @see smartgridinput.impl.SmartgridinputPackageImpl#getEntityState()
        ...
        /**
         * The meta object literal for the '{@link smartgridinput.impl.PowerStateImpl <em>Power
         * State</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
         * 
         * @see smartgridinput.impl.PowerStateImpl
         * @see smartgridinput.impl.SmartgridinputPackageImpl#getPowerState()
