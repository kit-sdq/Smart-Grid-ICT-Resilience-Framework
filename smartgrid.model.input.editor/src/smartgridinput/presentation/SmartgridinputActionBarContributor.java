...
/**
 * This is the action bar contributor for the Smartgridinput model editor. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class SmartgridinputActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    /**
     ...
     * @generated
     */
    protected IAction showPropertiesViewAction = new Action(SmartgridinputEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
     ...
     * @generated
     */
    protected IAction refreshViewerAction = new Action(SmartgridinputEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
     ...
     * @generated
     */
    public SmartgridinputActionBarContributor() {
    ...
    public void contributeToToolBar(IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("smartgridinput-settings"));
        toolBarManager.add(new Separator("smartgridinput-additions"));
    }
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(SmartgridinputEditorPlugin.INSTANCE.getString("_UI_SmartgridinputEditor_menu"), "smartgridinputMenuID");
        ...
        //
        createChildMenuManager = new MenuManager(SmartgridinputEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(SmartgridinputEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(SmartgridinputEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        populateManager(submenuManager, createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(SmartgridinputEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
