...
public class SmartgridoutputAdapterFactory extends AdapterFactoryImpl {
    ...
    /**
     * Creates a new adapter for an object of class '{@link smartgridoutput.Identifier <em>Identifier</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link smartgridoutput.Defect <em>Defect</em>}'.
     * <!-- begin-user-doc --> This default implementation returns null so that
     * we can easily ignore cases; it's useful to ignore a case when inheritance will catch all the
     * cases anyway. <!-- end-user-doc -->
     * @return the new adapter.
