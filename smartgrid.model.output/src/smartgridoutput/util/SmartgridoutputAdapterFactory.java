...
public class SmartgridoutputAdapterFactory extends AdapterFactoryImpl {
     ...
     * @generated
     */
    protected SmartgridoutputSwitch<Adapter> modelSwitch = new SmartgridoutputSwitch<Adapter>() {
        @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link smartgridoutput.ScenarioResult
     * <em>Scenario Result</em>}'. <!-- begin-user-doc --> This default implementation returns null
    ...
    /**
     * Creates a new adapter for an object of class '{@link smartgridoutput.EntityState <em>Entity
    ...
    /**
     * Creates a new adapter for an object of class '{@link smartgridoutput.Online
     * <em>Online</em>}'. <!-- begin-user-doc --> This default implementation returns null so that
    ...
    /**
     * Creates a new adapter for an object of class '{@link smartgridoutput.Defect
     * <em>Defect</em>}'. <!-- begin-user-doc --> This default implementation returns null so that
     * we can easily ignore cases; it's useful to ignore a case when inheritance will catch all the
     * cases anyway. <!-- end-user-doc -->
     * 
     * @return the new adapter.
    ...
    /**
     * Creates a new adapter for an object of class '{@link smartgridoutput.NoPower <em>No
    ...
    /**
     * Creates a new adapter for an object of class '{@link smartgridoutput.NoUplink <em>No
     * Uplink</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we
    ...
    /**
     * Creates a new adapter for an object of class '{@link smartgridoutput.Offline
     * <em>Offline</em>}'. <!-- begin-user-doc --> This default implementation returns null so that
     * we can easily ignore cases; it's useful to ignore a case when inheritance will catch all the
     * cases anyway. <!-- end-user-doc -->
     * 
     * @return the new adapter.
    ...
    /**
     * Creates a new adapter for an object of class '{@link smartgridoutput.Cluster
     * <em>Cluster</em>}'. <!-- begin-user-doc --> This default implementation returns null so that
     * we can easily ignore cases; it's useful to ignore a case when inheritance will catch all the
     * cases anyway. <!-- end-user-doc -->
     * 
     * @return the new adapter.
