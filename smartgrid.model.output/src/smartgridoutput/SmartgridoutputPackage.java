...
public interface SmartgridoutputPackage extends EPackage {
     ...
     * @ordered
     */
    int SCENARIO_RESULT__ENTITY_STATES = 0;
    ...
    /**
     * The meta object id for the '{@link smartgridoutput.impl.DestroyedImpl <em>Destroyed</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see smartgridoutput.impl.DestroyedImpl
     * @see smartgridoutput.impl.SmartgridoutputPackageImpl#getDestroyed()
     * @generated
     */
    int DESTROYED = 3;
     ...
     * @ordered
     */
    int DESTROYED__OWNER = ENTITY_STATE__OWNER;

    /**
     * The number of structural features of the '<em>Destroyed</em>' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     * @ordered
     */
    int DESTROYED_FEATURE_COUNT = ENTITY_STATE_FEATURE_COUNT + 0;

    /**
     * The number of operations of the '<em>Destroyed</em>' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     * @ordered
     */
    int DESTROYED_OPERATION_COUNT = ENTITY_STATE_OPERATION_COUNT + 0;
    ...
    /**
     * Returns the meta object for the containment reference list '{@link smartgridoutput.ScenarioResult#getEntityStates <em>Entity States</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the containment reference list '<em>Entity States</em>'.
     * @see smartgridoutput.ScenarioResult#getEntityStates()
     * @see #getScenarioResult()
     * @generated
     */
    EReference getScenarioResult_EntityStates();
    ...
    /**
     * Returns the meta object for class '{@link smartgridoutput.Destroyed <em>Destroyed</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for class '<em>Destroyed</em>'.
    ...
    /**
     * Returns the meta object for the attribute '{@link smartgridoutput.Cluster#getControlCenterCount <em>Control Center Count</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    interface Literals {
         ...
         * @generated
         */
        EReference SCENARIO_RESULT__ENTITY_STATES = eINSTANCE.getScenarioResult_EntityStates();
        ...
        /**
         * The meta object literal for the '{@link smartgridoutput.impl.DestroyedImpl <em>Destroyed</em>}' class.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @see smartgridoutput.impl.DestroyedImpl
         * @see smartgridoutput.impl.SmartgridoutputPackageImpl#getDestroyed()
         * @generated
         */
        EClass DESTROYED = eINSTANCE.getDestroyed();
