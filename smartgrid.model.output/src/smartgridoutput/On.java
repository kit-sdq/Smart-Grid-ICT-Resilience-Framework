...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>On</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
...
public interface On extends EntityState {
    /**
     * Returns the value of the '<em><b>Belongs To Cluster</b></em>' reference. It is bidirectional
     * and its opposite is '{@link smartgridoutput.Cluster#getHasEntities <em>Has Entities</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Belongs To Cluster</em>' reference isn't clear, there really
    ...
    /**
     * Sets the value of the '{@link smartgridoutput.On#getBelongsToCluster <em>Belongs To
     * Cluster</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Belongs To Cluster</em>' reference.
    ...
    /**
     * Returns the value of the '<em><b>Is Hacked</b></em>' attribute. The default value is
     ...
     * 
     * @param value
     *            the new value of the '<em>Is Hacked</em>' attribute.
     * @see #isIsHacked()
     * @generated
     */
