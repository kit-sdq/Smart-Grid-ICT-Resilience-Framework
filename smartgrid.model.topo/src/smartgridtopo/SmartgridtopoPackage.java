...
public interface SmartgridtopoPackage extends EPackage {
     ...
     * @ordered
     */
    int SMART_METER__ID = NETWORK_ENTITY__ID;
     ...
     * @ordered
     */
    int SMART_METER__NAME = NETWORK_ENTITY__NAME;
     ...
     * @ordered
     */
    int SMART_METER__CONNECTED_TO = NETWORK_ENTITY__CONNECTED_TO;
     ...
     * @ordered
     */
    int SMART_METER__LINKED_BY = NETWORK_ENTITY__LINKED_BY;
     ...
     * @ordered
     */
    int SMART_METER__COMMUNICATES_BY = NETWORK_ENTITY_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int SMART_METER__IS_A = NETWORK_ENTITY_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int SMART_METER_FEATURE_COUNT = NETWORK_ENTITY_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
    int SMART_METER_OPERATION_COUNT = NETWORK_ENTITY_OPERATION_COUNT + 0;
     ...
     * @ordered
     */
    int CONTROL_CENTER__ID = NETWORK_ENTITY__ID;
     ...
     * @ordered
     */
    int CONTROL_CENTER__NAME = NETWORK_ENTITY__NAME;
     ...
     * @ordered
     */
    int CONTROL_CENTER__CONNECTED_TO = NETWORK_ENTITY__CONNECTED_TO;
     ...
     * @ordered
     */
    int CONTROL_CENTER__LINKED_BY = NETWORK_ENTITY__LINKED_BY;
     ...
     * @ordered
     */
    int CONTROL_CENTER__COMMUNICATES_BY = NETWORK_ENTITY_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int CONTROL_CENTER_FEATURE_COUNT = NETWORK_ENTITY_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int CONTROL_CENTER_OPERATION_COUNT = NETWORK_ENTITY_OPERATION_COUNT + 0;
