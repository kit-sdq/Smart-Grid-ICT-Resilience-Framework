...
public class SmartgridtopoPackageImpl extends EPackageImpl implements SmartgridtopoPackage {
     ...
     * 
     * <p>This method is used to initialize {@link SmartgridtopoPackage#eINSTANCE} when that field is accessed.
    ...
    public static SmartgridtopoPackage init() {
        if (isInited) return (SmartgridtopoPackage)EPackage.Registry.INSTANCE.getEPackage(SmartgridtopoPackage.eNS_URI);

        // Obtain or create and register package
        SmartgridtopoPackageImpl theSmartgridtopoPackage = (SmartgridtopoPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SmartgridtopoPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SmartgridtopoPackageImpl());
     ...
     * @generated
     */
    public EReference getScenario_ContainsNE() {
     ...
     * @generated
     */
    public EReference getScenario_ContainsPGN() {
     ...
     * @generated
     */
    public EReference getScenario_ContainsC() {
     ...
     * @generated
     */
    public EReference getScenario_ContainsLC() {
    ...
    public void createPackageContents() {
        ...
        createEReference(scenarioEClass, SCENARIO__CONTAINS_NE);
        createEReference(scenarioEClass, SCENARIO__CONTAINS_PGN);
        createEReference(scenarioEClass, SCENARIO__CONTAINS_C);
        createEReference(scenarioEClass, SCENARIO__CONTAINS_LC);
    ...
    public void initializePackageContents() {
        ...
        scenarioEClass.getESuperTypes().add(this.getNamedIdentifier());
        ...
        smartMeterEClass.getESuperTypes().add(this.getNetworkEntity());
        ...
        controlCenterEClass.getESuperTypes().add(this.getNetworkEntity());
        ...
        initEReference(getScenario_ContainsNE(), this.getNetworkEntity(), null, "ContainsNE", null, 0, -1, Scenario.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getScenario_ContainsPGN(), this.getPowerGridNode(), null, "ContainsPGN", null, 0, -1, Scenario.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getScenario_ContainsC(), this.getPhysicalConnection(), null, "ContainsC", null, 0, -1, Scenario.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getScenario_ContainsLC(), this.getLogicalCommunication(), null, "ContainsLC", null, 0, -1, Scenario.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getSmartMeter_IsA(), this.getSmartMeterType(), null, "IsA", null, 0, 1, SmartMeter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getPhysicalConnection_IsA(), this.getConnectionType(), null, "IsA", null, 0, 1, PhysicalConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getNetworkNode_IsA(), this.getNetworkNodeType(), null, "IsA", null, 0, 1, NetworkNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getNetworkNodeType_IsA(), this.getSmartMeterType(), null, "IsA", null, 1, 1, NetworkNodeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
