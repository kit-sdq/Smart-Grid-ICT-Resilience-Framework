...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Logical Communication</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class LogicalCommunicationImpl extends MinimalEObjectImpl.Container implements LogicalCommunication {
	...
	public EList<CommunicatingEntity> getLinks() {
		if (links == null) {
			links = new EObjectWithInverseResolvingEList.ManyInverse<CommunicatingEntity>(CommunicatingEntity.class, this, SmartgridtopoPackage.LOGICAL_COMMUNICATION__LINKS, SmartgridtopoPackage.COMMUNICATING_ENTITY__COMMUNICATES_BY);
		}
		return links;
	}
