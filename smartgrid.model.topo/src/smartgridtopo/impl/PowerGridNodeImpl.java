...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Power Grid Node</b></em>'.
 * <!-- end-user-doc -->
 * <p>
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedEntity.class) {
			switch (derivedFeatureID) {
				case SmartgridtopoPackage.POWER_GRID_NODE__NAME: return SmartgridtopoPackage.NAMED_ENTITY__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedEntity.class) {
			switch (baseFeatureID) {
				case SmartgridtopoPackage.NAMED_ENTITY__NAME: return SmartgridtopoPackage.POWER_GRID_NODE__NAME;
				default: return -1;
			}
		}
