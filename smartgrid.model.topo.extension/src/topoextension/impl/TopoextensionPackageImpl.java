...
public class TopoextensionPackageImpl extends EPackageImpl implements TopoextensionPackage {
     ...
     */
    @Override
    public EReference getExtensionRepository_Aggregations() {
    ...
    public void createPackageContents() {
        ...
        createEReference(extensionRepositoryEClass, EXTENSION_REPOSITORY__AGGREGATIONS);
    ...
    public void initializePackageContents() {
        ...
        initEReference(getExtensionRepository_Aggregations(), getAggregation(), null, "aggregations", null, 0, -1, ExtensionRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
