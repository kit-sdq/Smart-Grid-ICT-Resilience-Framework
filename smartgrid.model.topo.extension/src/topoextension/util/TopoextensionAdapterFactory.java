...
public class TopoextensionAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected TopoextensionSwitch<Adapter> modelSwitch =
		new TopoextensionSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link topoextension.ExtensionRepository <em>Extension Repository</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link topoextension.Replication <em>Replication</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
