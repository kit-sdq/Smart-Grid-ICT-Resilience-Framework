 ...
 *   <li>{@link smartgridtopo.impl.RepositoryImpl#getContainsSmartMeterTypes <em>Contains Smart Meter Types</em>}</li>
 *   <li>{@link smartgridtopo.impl.RepositoryImpl#getContainsConnectionType <em>Contains Connection Type</em>}</li>
 *   <li>{@link smartgridtopo.impl.RepositoryImpl#getContainsNetworkNodeTypes <em>Contains Network Node Types</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedEntity.class) {
			switch (derivedFeatureID) {
				case SmartgridtopoPackage.REPOSITORY__NAME: return SmartgridtopoPackage.NAMED_ENTITY__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedEntity.class) {
			switch (baseFeatureID) {
				case SmartgridtopoPackage.NAMED_ENTITY__NAME: return SmartgridtopoPackage.REPOSITORY__NAME;
				default: return -1;
			}
		}
