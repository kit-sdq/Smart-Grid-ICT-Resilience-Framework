...
public class SmartgridtopoPackageImpl extends EPackageImpl implements SmartgridtopoPackage {
	...
	public static SmartgridtopoPackage init() {
		...
		TopoextensionPackageImpl theTopoextensionPackage = (TopoextensionPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(TopoextensionPackage.eNS_URI) instanceof TopoextensionPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(TopoextensionPackage.eNS_URI) : TopoextensionPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		initEReference(getSmartGridTopology_ContainsNE(), this.getNetworkEntity(), null, "ContainsNE", null, 0, -1, SmartGridTopology.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSmartGridTopology_ContainsPGN(), this.getPowerGridNode(), null, "ContainsPGN", null, 0, -1, SmartGridTopology.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSmartGridTopology_ContainsPC(), this.getPhysicalConnection(), null, "ContainsPC", null, 0, -1, SmartGridTopology.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSmartGridTopology_ContainsLC(), this.getLogicalCommunication(), null, "ContainsLC", null, 0, -1, SmartGridTopology.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
