...
public class DummySimulationController implements ISimulationController {
  ...
  /* (non-Javadoc)
   * @see smartgrid.simcontrol.coupling.ISimulationController#init(java.lang.String, java.lang.String, java.lang.String)
   */
  @Override public void init(String outputPath, String topoPath, String inputStatePath) throws RemoteException, SimcontrolException {
    System.out.println("RMI: init called");
  }

  /* (non-Javadoc)
   * @see smartgrid.simcontrol.coupling.ISimulationController#run(java.util.Map)
   */
  @Override public Map<String, Map<String, Double>> run(Map<String, Map<String, PowerSpec>> kritisPowerDemand) throws RemoteException {
