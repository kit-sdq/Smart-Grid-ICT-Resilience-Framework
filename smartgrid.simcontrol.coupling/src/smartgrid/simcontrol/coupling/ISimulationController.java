...
/**
 * Initializing topological quantities within the connected ICT-module,
 * retrieving supplied power acoording to the conditions described in the 
 * power specific data sheet per CI entity
 */
