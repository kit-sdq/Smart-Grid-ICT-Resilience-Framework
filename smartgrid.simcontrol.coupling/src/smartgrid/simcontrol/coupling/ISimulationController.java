...
public interface ISimulationController extends Remote {
    ...
    /**
     * Get a list of power supplied to ... 
     * Remotely aborting leaves an undefined state and requires the connection to be reinitialised before continuing.
     * @param kritisPowerDemand
     * @return 
     * @throws RemoteException if 
     * @throws SimcontrolException
     * @throws InterruptedException if aborted remotely
     */
