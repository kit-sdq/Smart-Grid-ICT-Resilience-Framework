...
/**
 * This is the item provider adapter for a {@link smartgridtopo.SmartMeterType} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class SmartMeterTypeItemProvider extends ItemProviderAdapter
     ...
     * @generated
     */
    public SmartMeterTypeItemProvider(AdapterFactory adapterFactory) {
    ...
    /**
     * This returns SmartMeterType.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/SmartMeterType"));
    }
    ...
    public String getText(Object object) {
        String label = ((SmartMeterType) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_SmartMeterType_type") : getString("_UI_SmartMeterType_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(SmartMeterType.class)) {
