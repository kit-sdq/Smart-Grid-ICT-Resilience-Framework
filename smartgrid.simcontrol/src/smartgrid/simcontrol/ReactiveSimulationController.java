...
//        FileSystemHelper.saveToFileSystem(topo, topoPath + ".completion.smartgridtopo");
    ...
    public void initModelsAutogenerated() throws InterruptedException {

        // get geodata from Kritis simulation
        TopologyContainer topoData = BlockingKritisDataExchanger.getTopoData();
