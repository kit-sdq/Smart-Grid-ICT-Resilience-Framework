...
//        reactiveSimControl.initModelsAutogenerated(); // TODO: add setting in GUI
        reactiveSimControl.loadCustomUserAnalysis(launchConfig);

        kritisSimulation = SimulationExtensionPointHelper.findExtension(launchConfig, SimulationExtensionPointHelper.getKritisSimulationExtensions(), Constants.KRITIS_SIMULATION_KEY,
