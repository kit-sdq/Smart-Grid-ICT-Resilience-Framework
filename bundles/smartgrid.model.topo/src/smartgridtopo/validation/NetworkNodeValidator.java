...
/**
 * A sample validator interface for {@link smartgridtopo.NetworkNode}. This doesn't really do
 ...
 */
public interface NetworkNodeValidator {
    boolean validate();

    boolean validateIsA(NetworkNodeType value);
}
