...
public class FeatureRepresentationHelper {
	 ...
	 */
	public static GraphicsAlgorithm createEllipse(ContainerShape containerShape, Color colorForeground, Color colorBackground) {
	 ...
	 */
	public static GraphicsAlgorithm createRect(ContainerShape containerShape, Color colorForeground, Color colorBackground) {
		final IGaService gaService = Graphiti.getGaService();
	 ...
	 */
	public static GraphicsAlgorithm createPolygon(ContainerShape containerShape, Color colorForeground, Color colorBackground) {
		final IGaService gaService = Graphiti.getGaService();
        int halfWidth = 13;
