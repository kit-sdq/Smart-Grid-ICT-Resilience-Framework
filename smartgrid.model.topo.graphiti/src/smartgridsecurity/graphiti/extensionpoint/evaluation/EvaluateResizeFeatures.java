...
/**
 * This class evaluates the resize feature extension point and adds all resize feature instances to a list.
 * @author mario
 *
 */
			...
			for (IConfigurationElement e : config) {
				...
				if (o instanceof IResizeFeatureResolver) {
					//Executes the evaluation in a thread an returns the result in the future 
				      Callable<List<IResizeShapeFeature>> callable = new EvaluateAbstractPattern((IResizeFeatureResolver) o, fp);
