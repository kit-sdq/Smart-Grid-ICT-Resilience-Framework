...
/**
 * This is the action bar contributor for the Topoextension model editor. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class TopoextensionActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    /**
     ...
     * @generated
     */
    protected IAction showPropertiesViewAction = new Action(TopoextensionEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
     ...
     * @generated
     */
    protected IAction refreshViewerAction = new Action(TopoextensionEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
     ...
     * @generated
     */
    public TopoextensionActionBarContributor() {
    ...
    public void contributeToToolBar(IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("topoextension-settings"));
        toolBarManager.add(new Separator("topoextension-additions"));
    }
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(TopoextensionEditorPlugin.INSTANCE.getString("_UI_TopoextensionEditor_menu"), "topoextensionMenuID");
        ...
        //
        createChildMenuManager = new MenuManager(TopoextensionEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(TopoextensionEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(TopoextensionEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        populateManager(submenuManager, createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(TopoextensionEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
