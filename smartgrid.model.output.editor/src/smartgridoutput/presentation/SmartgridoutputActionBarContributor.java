...
/**
 * This is the action bar contributor for the Smartgridoutput model editor. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class SmartgridoutputActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    /**
     ...
     * @generated
     */
    protected IAction showPropertiesViewAction = new Action(SmartgridoutputEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
     ...
     * @generated
     */
    protected IAction refreshViewerAction = new Action(SmartgridoutputEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
     ...
     * @generated
     */
    public SmartgridoutputActionBarContributor() {
    ...
    public void contributeToToolBar(IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("smartgridoutput-settings"));
        toolBarManager.add(new Separator("smartgridoutput-additions"));
    }
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(SmartgridoutputEditorPlugin.INSTANCE.getString("_UI_SmartgridoutputEditor_menu"), "smartgridoutputMenuID");
        ...
        //
        createChildMenuManager = new MenuManager(SmartgridoutputEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(SmartgridoutputEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(SmartgridoutputEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        populateManager(submenuManager, createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(SmartgridoutputEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
